...
\section{Pravidlá a postihy}
    \begin{itemize}
        ...
        \item[$\skull$] Príklady posielaj načas! Dôležitý je \emph{termín odoslania} riešení (ak posielaš poštou, tak rozhoduje pečiatka odoslania).
            ...
            Riešenia odovzdané neskôr už neakceptujeme. Ak kvôli nejakému závažnému dôvodu nestíhaš odoslať riešenia načas, neváhaj nás kontaktovať na \URL{(* competition.email *)}
...
\subsection{Ako získať za moje riešenie veľa bodov?}
    ...
    e-mailom na \URL{(* competition.email *)}. Ak by bola v~príklade nejaká vážnejšia
...
\subsection{Chcem začať riešiť! Čo mám spraviť?}
    Zaregistruj sa na \URL{(* competition.url *)} a~začni čo najskôr počítať. Nečakaj však, že všetko stihneš porátať
