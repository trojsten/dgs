...
\fancypagestyle{main}{%
    \fancyhead[LO,RE]{%
        \raisebox{(* competition.hacks.smallLogoRaise *)}{%
            \includegraphics[keepaspectratio = true, height = 6mm]{input/(* module.id *)/(* competition.id *)/logo.pdf}%
        }%
    }%
...
\fancypagestyle{first}{%
    ...
    \fancyhead[R]{
        \begin{minipage}{0.2\textwidth}
            \flushright
            \includegraphics[width = 30mm, keepaspectratio = true]{input/(* module.id *)/(* competition.id *)/logo.pdf}\\[0pt]
            \vspace{4pt}
        \end{minipage}
    }
    \fancyfoot[LO,RE]{\href{mailto:(* i18n.competition.email *)}{\texttt{(* i18n.competition.email *)}}}
