...
\fancypagestyle{first}{%
    ...
    \fancyhead[C]{
        \begin{minipage}{0.7\textwidth}
            ...
            {\footnotesize (* i18n.competition.organisation.short *), (* i18n.competition.organisation.short *), (* seminar.fullAddress *)}\\[2pt]
            \vspace{6pt}
        \end{minipage}        
    }           
    \fancyhead[R]{
        \begin{minipage}{0.2\textwidth}
            \flushright
            \includegraphics[width = 30mm, keepaspectratio = true]{modules/(* module.id *)/styles/(* seminar.id *)/logo/logo.pdf}\\[0pt]
            \vspace{4pt}
        \end{minipage}
    }
