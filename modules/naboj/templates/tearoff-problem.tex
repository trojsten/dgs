...
\begin{minipage}[t][94mm][t]{\textwidth}%
    ...
    \begin{minipage}[t][88mm][t]{0.149\linewidth}
        ...
        \rotatebox{90}{%
            \hspace{15mm}%
            \textsf{%
                \fontsize{28}{0}\selectfont (* team.id *)%
                \fontsize{20}{0}\selectfont(@ block probnum2 @)(* '%02d'|format(problem.number) *)(@ endblock probnum2 @)%
                \fontsize{20}{0}\selectfont(@ block checkdigit @)(* '%01d'|format(checkdigit(team.id, problem.number)) *)(@ endblock checkdigit @)%
            }%
        }%
        \hspace{2pt}
        \rotatebox{90}{%
