    ...
    (@ for team3 in venue.teams3 @)
        (@ for problem in volume.problems @)
            (@ for team in team3 @)%
                ...
                \RenewDocumentCommand{\problemDirectory}{}{\rootDirectory/(* module.id *)/(* seminar.id *)/(* volume.id *)/languages/(* team.language *)/(* problem.id *)}%
                \begin{minipage}[t][90mm][t]{\textwidth}%
                    ...
                    \begin{minipage}[t][82mm][t]{0.125\linewidth}\vspace{0pt}%
                        ...
                        \rotatebox{90}{%
                            \includegraphics[%
                                width = 70mm, height = 15mm, page = (* team.number * volume.problems|length + problem.number *)]{\rootDirectory/(* module.id *)/(* seminar.id *)/(* volume.id *)/venues/(* venue.id *)/barcodes.pdf}%
                            \hspace{5mm}%
                        }%
                    \end{minipage}
