    ...
    (@ for team3 in venue.teamsDiv3 @)
        (@ for problem in volume.problems @)
            (@ for team in team3 @)%
                ...
                \begin{minipage}[t][95mm][t]{\textwidth}%
                    \begin{minipage}[t][85mm][t]{0.875\linewidth}\vspace{0pt}%
                        \subsection{\texorpdfstring{(* problem.number *)}{(* problem.number *). (* problem.id *)}}%
                        \setlength{\parskip}{6pt}
                        \protectedInput{\activeDirectory/problem.tex}%
                    \end{minipage}%
                    \begin{minipage}[t][85mm][t]{0.125\linewidth}\vspace{0pt}%
                        \hspace{2mm}
                        \rotatebox{90}{%
                            \hspace{16mm}
                            \textsf{%
                        ...
                        \rotatebox{90}{%
                            \includegraphics[%
                                width = 78mm, height = 13mm, page = (* team.number * volume.problems|length + problem.number *)]{%
