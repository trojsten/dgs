...
\fancypagestyle{first}{%
    ...
    \fancyhead[C]{
        \begin{minipage}{0.7\textwidth}
            ...
            {\large (* volume.number|roman *). ročník, (* volume.date.strftime('%d. %m. %Y') *)}\\[8pt]            
            {\footnotesize (* competition.organisation.name.short *), (* competition.organisation.department.short *) (* competition.organisation.faculty.short *), (* competition.organisation.address *)}\\[2pt]
            \vspace{6pt}
        \end{minipage}        
    }           
    \fancyhead[R]{
