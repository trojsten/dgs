...
%[Fraunhofer_lines.svg]{Obrázok \emph{Fraunhoferových čiar}, spektrálnych čiar v~spektre Slnka.\footnote{Obrázok prepožičaný z~\url{https://upload.wikimedia.org/wikipedia/commons/2/2f/Fraunhofer_lines.svg}}.}
%Obrázok nemá žiadne podmienky, takže je to legal :)
%[Kvík] Tuším celá wikimedia obsahuje iba free obrázky... ale isté si nie som.

%\obrazok{0.5}{pr7b.eps}{Obrázok \emph{Fraunhoferových čiar} -- spektrálnych čiar v~spektre Slnka.
%Obrázok je prepožičaný z~\protect\url{https://upload.wikimedia.org/wikipedia/commons/2/2f/Fraunhofer_lines.svg}.}{fraunhoferlines}{H}
...
%[Kvík] Obrázok asi treba aj vložiť
% [planckian locus]{Na obrázku môžeme vidieť krivku, na ktorej je znázornená teplota v~Kelvinoch. A~príslušné farby, ktoré zodpovedajú príslušnej teplote absolútne čierneho telesa.}
%Opäť legal for any use :)
%\obrazok{0.4}{pr7.eps}{Na obrázku môžeme vidieť krivku, na ktorej je znázornená teplota v~Kelvinoch. A~príslušné farby, ktoré zodpovedajú príslušnej teplote absolútne čierneho telesa.}{planckianlocus}{H}
...
Našťastie nemusíme dlho hladať, pretože ak sa trošku posnažíme, dopátrame sa k~tzv. \emph{CIE color matching functions}\footnote{\url{https://en.wikipedia.org/wiki/CIE_1931_color_space(MRIEŽKA) Color_matching_functions}},
...
Iný spôsob bol priamo nájsť približné vzťahy\footnote{\url{https://en.wikipedia.org/wiki/Planckian_locus(MRIEŽKA)Approximation}} na výpočet $X$ a $Y$ súradníc v~$CEI$ farebnom spektre priamo z~teploty a potom prepočítať na RGB farbu.
