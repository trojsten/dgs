%Nastavte si prosím kódovanie UTF-8 NOBOMB a unixové konce riadkov
...
\obrazok{0.5}{pr7b.eps}{Obrázok \emph{Fraunhoferových čiar} -- spektrálnych čiar v~spektre Slnka. Obrázok je prepožičaný z~\protect\url{https://upload.wikimedia.org/wikipedia/commons/2/2f/Fraunhofer_lines.svg}.}{fraunhoferlines}{H}
% \footnote{Obrázok prepožičaný z~\url{https://upload.wikimedia.org/wikipedia/commons/2/2f/Fraunhofer_lines.svg}}.
