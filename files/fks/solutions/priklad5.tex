...
%\begin{figure}[H]
%\includegraphics[]{}\protect\caption{Náhradné zapojenie s~jedným článkom}
%\end{figure}
\obrazok{0.4}{o.eps}{Náhradné zapojenie s~jedným článkom}{zapojenie1}{H}
...
%\begin{figure}[h]
%\includegraphics[]{}\protect\caption{Obvod s~$n$ článkami zapojenými v~sérii}
%\end{figure}
\obrazok{0.5}{o2.eps}{Obvod s~$n$ článkami zapojenými v~sérii}{zapojenie1}{H}
...
%\begin{figure}[h]
%\includegraphics[]{}\protect\caption{Obvod s~$n$ článkami zapojenými paralelne}
%\end{figure}
\obrazok{0.5}{o3.eps}{Obvod s~$n$ článkami zapojenými paralelne}{zapojenie1}{H}
...
%\begin{figure}[h]
%\includegraphics[]{}\protect\caption{Najjednoduchšie ,,hybridné`` zapojenie pozostávajúce z~3 komponentov}
%\end{figure}
\obrazok{0.6}{o4.eps}{Najjednoduchšie \uv{hybridné} zapojenie pozostávajúce z~3 zdrojov\label{obr}}{zapojenie1}{H}
% \obrazok{0.35}{o1.eps}{Najjednoduchšie \uv{hybridné} zapojenie pozostávajúce z~3 zdrojov}{zapojenie1}{H}
...
%\begin{figure}[H]
%\includegraphics[]{}\protect\caption{Prehľad všetkých zapojení 4 zdrojov}
%\end{figure}
\obrazok{0.7}{o5.eps}{Prehľad všetkých zapojení 4 zdrojov}{zapojenie1}{H}
