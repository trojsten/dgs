...
\NewDocumentCommand{\DerivativeEmpty}{O{} m}{\DerivativeEmpty@[#1]{\diff}{#2}}
\NewDocumentCommand{\PDerivativeEmpty}{O{} m}{\DerivativeEmpty@[#1]{\pdiff}{#2}}
\NewDocumentCommand{\FDerivativeEmpty}{O{} m}{\DerivativeEmpty@[#1]{\fdiff}{#2}}
\NewDocumentCommand{\UDerivativeEmpty}{O{} m}{\DerivativeEmpty@[#1]{\udiff}{#2}}
...
\NewDocumentCommand{\DerivativeParen}{O{} m m}{\DerivativeParentheses@[#1]{\diff}{#2}{#3}}
\NewDocumentCommand{\PDerivativeParen}{O{} m m}{\DerivativeParentheses@[#1]{\pdiff}{#2}{#3}}
\NewDocumentCommand{\FDerivativeParen}{O{} m m}{\DerivativeParentheses@[#1]{\fdiff}{#2}{#3}}
\NewDocumentCommand{\UDerivativeParen}{O{} m m}{\DerivativeParentheses@[#1]{\udiff}{#2}{#3}}
