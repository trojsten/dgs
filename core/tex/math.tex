...
\NewDocumentCommand{\uvec}{m}{\Hat{\mathbf{#1}}}
%\NewDocumentCommand{\Avec}{m}{\vec{#1}}
%\NewDocumentCommand{\Bvec}{m}{\mathbf{#1}}
...
\NewDocumentCommand{\Implies}{}{\QText{\Rightarrow}}
...
\NewDocumentCommand{\IntervalCC}{m m}{\left\langle #1; #2\right\rangle}
