...
\DeclareMathOperator{\LXor}{xor}
\DeclareMathOperator{\LOr}{or}
\DeclareMathOperator{\LAnd}{and}
\DeclareMathOperator{\LNand}{nand}
...
\NewDocumentCommand{\UnitVector}{m}{\mathbf{\Hat[-1.7mm]{\vec{#1}}}}
...
\NewDocumentCommand{\IntervalCC}{m m}{\langle #1; #2\rangle}
\NewDocumentCommand{\IntervalCO}{m m}{\left\langle #1; #2\right)}
\NewDocumentCommand{\IntervalOC}{m m}{\left( #1; #2\right\rangle}
