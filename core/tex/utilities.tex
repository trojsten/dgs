...
%   - extension for PDF
%   - extension for HTML (ignored)
%   - height
%   - caption below the picture
%   - label, should begin with "fig:"
...
\NewDocumentCommand{\OInt}{O{} O{} m m}{\kern -0.2em \oint\limits_{#1}^{#2} #3 \, \diff#4}
...
\NewDocumentCommand{\Nuclide}{O{} O{} m}{\ensuremath{\leftidx{^{#1}_{#2}}{\mathrm{#3}}{}}}
