...
\NewDocumentCommand{\Diff}{e{^_} m}{%
    \diff@\IfValueT{#1}{^{#1}}\IfValueT{#2}{_{#2}} #3%
}
\NewDocumentCommand{\PDiff}{e{^_} m}{%
    \pdiff@\IfValueT{#1}{^{#1}}\IfValueT{#2}{_{#2}} #3%
}
\NewDocumentCommand{\FDiff}{e{^_} m}{%
    \fdiff@\IfValueT{#1}{^{#1}}\IfValueT{#2}{_{#2}} #3%
}
\NewDocumentCommand{\UDiff}{e{^_} m}{%
    \udiff@\IfValueT{#1}{^{#1}}\IfValueT{#2}{_{#2}} #3%
}
