...
% Power differential (rewrite this to one common function \diff@...)
...
\NewDocumentCommand{\FDiff}{o}{%
    \IfNoValueTF{#1}{\fdiff@}{\fdiff@^{#1}}%
}
\NewDocumentCommand{\UDiff}{o}{%
    \IfNoValueTF{#1}{\udiff@}{\udiff@^{#1}}%
}
