...
\insertPicture{task4-graph1.pdf}{4cm}[Grafické spracovanie prvého merania (Áno, nemám graf plný bodov, lebo som si povedala, že na ukážku to bude stačiť. Verím, že vy máte lepšie.)][first]

Druhé meranie nám poskytlo takýto výsledok:

\insertPicture{task4-graph2.pdf}{4cm}[Grafické spracovanie druhého merania][second]
