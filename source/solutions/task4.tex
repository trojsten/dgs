...
\insertPicture{task4-graph1.pdf}{80mm}[Grafické spracovanie prvého merania (Áno, nemám graf plný bodov, lebo som si povedala, že na ukážku to bude stačiť. Verím, že vy máte lepšie.)][first]

Druhé meranie nám poskytlo takýto výsledok:
\nopagebreak
\insertPicture{task4-graph2.pdf}{80mm}[Grafické spracovanie druhého merania][second]
