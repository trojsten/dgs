...
\insertPicture{task7-fraunhofer.pdf}{4cm}[Obrázok \emph{Fraunhoferových čiar} -- spektrálnych čiar v~spektre Slnka.%
...
\insertPicture{task7-planck.png}{8cm}[Na obrázku môžeme vidieť krivku, na ktorej je znázornená teplota v~Kelvinoch. A~príslušné farby, ktoré zodpovedajú príslušnej teplote absolútne čierneho telesa.][planck]
